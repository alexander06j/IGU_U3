...
public class Ventana extends javax.swing.JFrame {
    ...
    //mostrar notificacion sencilla
    public void mostrarNotificacion(String mensaje) {
        JOptionPane.showMessageDialog(this, mensaje);
    }

    // Mostrar los resultados en la JList (list_contactos)
    public void mostrarResultadosEnLista(List<Persona> lista) {
        DefaultListModel<String> modelo = (DefaultListModel<String>) list_contactos.getModel();
        modelo.clear();
        for (Persona p : lista) {
    ...
    private void inicializarModeloTabla() {
        ...
        list_contactos.setModel(modeloLista);
    }
...
//    public void mostrarResultadosBusqueda(List<Persona> resultados) {
//       
//    }
